...
class shp_to_network(object):
    ...
    def __init__(self, shpFile):
        ...
        self.roads_raw = self.fetch_roads(shpFile)

    def generateRoadsGDF(self, in_df = None, unique_id = 'osm_id', outFile = '', verbose = False):
        """
    ...
    def fetch_roads(self, data_path):
        ...
        if data_path.split('.')[-1] == 'pbf':
            ...
            # needs to produce a geometry column? test this
